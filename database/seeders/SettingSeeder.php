    ...
    { 
        ...
        [
          ...
          [
            ...
            'field_type' => 'select',
            'dataset'=> null,
            'data_source' => 'am__warehouses-status,1-name,warehouse_id',
            'code' => 'apparelmagic_location',
            'title' => 'Location',
            'placeholder' => '',
            'value' =>'',
        ...
        [
            ...
            'field_type' => 'select',
            'dataset'=> null,
            'data_source' => 'am__divisions-status,1-name,division_id',
            'code' => 'apparelmagic_division',
            'title' => 'Division',
            'placeholder' => '',
            'value' =>'',
            'status' => 1,
           ...
           [
            ...
            'field_type' => 'select',
            'dataset'=> null,
            'data_source' => 'am__accounts-status,1-name,account_id',
            'code' => 'apparelmagic_account',
            'title' => 'Account',
            'placeholder' => '',
            'value' =>'',
            'status' => 1,
           ...
           [
            ...
            'field_type' => 'select',
            'dataset'=> null,
            'data_source' => 'am__customers-status,1-name,am_customer_id',
            'code' => 'apparelmagic_customer',
            'title' => 'Customer',
            'placeholder' => '',
            'value' =>'',
            'status' => 1,
